...
#main.py -h 192.168.5.200  --use-pms5003

def parse_args():
    ap = argparse.ArgumentParser(add_help=False)
    ap.add_argument("-h", "--host", required=False,default="192.168.5.200", help="the MQTT host to connect to")
    ...
    ap.add_argument("--prefix", default="ENVIRO", help="the topic prefix to use when publishing readings, i.e. 'lounge/enviroplus'")
    ...
    ap.add_argument("--delay", type=int, default=5, help="the duration in seconds to allow the sensors to stabilise before starting to publish readings")
    ap.add_argument("--use-pms5003", default=True, action="store_true", help="if set, PM readings will be taken from the PMS5003 sensor")
